...
namespace TF2_Simulator
{
    internal class Game
    {
        ...
        {
            Console.Write("This game uses Saves."); Thread.Sleep(1000); Console.Write(" Checking for Saves... ");
            int SavesDiscovered = 0;
            for (int i = 1; i <= 100; i++)
            {
                ...
                try
                {
                    ...
                    {
                        Console.WriteLine($"Save File {i} Found!");
                        SavesDiscovered++;
                        //writes to file
            ...
            if (SavesDiscovered > 0)
            {
                Console.WriteLine("Saves Discovered!");
                for (int a = 1; a <= 100; a++)
                {
                    Console.WriteLine($"[{a}. (PlayerName) | Inventory [(InventoryCount)/(MaxInventory)]");
                }
            }
            Console.WriteLine("What save do you want to load?");
